...
// Public methods
// inside the ws member we can pass any other arguments, after io context
...
)
{
    ...
    // We check the lowest layer, which is the TCP:
...
)
{
    ...
    // When connection has been stablished the handshake of the TLS must be done
